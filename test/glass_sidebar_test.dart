...
void main() {
  testWidgets('GlassSidebar expands into rectangle brick with item names on hover',
    ...
    final RenderBox initialBox = tester.renderObject(animatedContainerFinder);
    ...
    final RenderBox expandedBox = tester.renderObject(animatedContainerFinder);
    ...
    final RenderBox collapsedBox = tester.renderObject(animatedContainerFinder);
